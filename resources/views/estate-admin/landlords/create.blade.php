...
<div class="container px-6 mx-auto">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('estate.landlords.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 transition-colors">
            <i class="fas fa-arrow-left mr-2"></i> Back to Landlords
        </a>
    </div>

    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('estate.landlords.store') }}" method="POST">
            @csrf
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            ...
                            If you need to create a new user account for this landlord, please select the option below.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div x-data="{ activeTab: '{{ old('create_account', 'no') === 'yes' ? 'create_account' : 'existing_account' }}', accountType: '{{ old('is_company', '0') === '1' ? 'company' : 'individual' }}', createUserAccount: {{ old('create_account', 'no') === 'yes' ? 'true' : 'false' }} }">
                ...
                <div class="mb-6">
                    ...
                    <!-- Estate ID is automatically set to the current estate -->
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('estate.landlords.index') }}" class="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-100 transition-colors">
                    Cancel
                </a>
