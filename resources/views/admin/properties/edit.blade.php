        ...
        <form action="{{ route('admin.properties.update', $property) }}" method="POST">
            ...
            <div class="space-y-6">
                        ...
                        <select name="landlord_id" id="landlord_id"
                            ...
                            @foreach($landlords as $landlord)
                                <option value="{{ $landlord->id }}" {{ old('landlord_id', $property->landlord_id) == $landlord->id ? 'selected' : '' }}>
                                    ...
                                    @endif
                                    - {{ $landlord->estate->name }}
                                </option>
                            @endforeach
                        </select>
                        <a href="{{ route('admin.landlords.create') }}" class="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Property Name <span class="text-red-500">*</span></label>
                        <input type="text" name="property_name" value="{{ old('property_name', $property->property_name) }}" required
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Property Number <span class="text-red-500">*</span></label>
                        <input type="text" name="old_property_number" value="{{ old('old_property_number', $property->old_property_number) }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Property Category <span class="text-red-500">*</span></label>
                        <select name="type" required
                            ...
                            <option value="residential" {{ old('type', $property->type ?? 'residential') == 'residential' ? 'selected' : '' }}>Residential</option>
                            <option value="commercial" {{ old('type', $property->type ?? 'commercial') == 'commercial' ? 'selected' : '' }}>Commercial</option>
                        </select>
                        @error('type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="property_type" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('property_type') border-red-500 @enderror">
                ...
                <!-- Units -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Number of Units <span class="text-red-500">*</span></label>
                    <input type="number" name="units" value="{{ old('units', $property->units) }}" required min="1"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('units') border-red-500 @enderror">
                    @error('units')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div>
                        ...
                        <input type="number" name="old_bedrooms" value="{{ old('old_bedrooms', $property->old_bedrooms) }}" min="0"
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Bedrooms Per Unit</label>
                        <input type="number" name="bedrooms_per_unit" value="{{ old('bedrooms_per_unit', $property->bedrooms_per_unit) }}" min="0"
                    ...
                    <div>
                        ...
                        <input type="number" name="old_bathrooms" value="{{ old('old_bathrooms', $property->old_bathrooms) }}" min="0"
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Bathrooms Per Unit</label>
                        <input type="number" name="bathrooms_per_unit" value="{{ old('bathrooms_per_unit', $property->bathrooms_per_unit) }}" min="0"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Size (legacy)</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Size (sqm/sqft)</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Size Unit</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" name="old_rent_amount" value="{{ old('old_rent_amount', $property->old_rent_amount) }}" required min="0" step="0.01"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('old_rent_amount') border-red-500 @enderror">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Rent Per Unit (₦)</label>
                        <input type="number" name="rent_amount_per_unit" value="{{ old('rent_amount_per_unit', $property->rent_amount_per_unit) }}" min="0" step="0.01"
                    ...
                    <div>
                        ...
                        <select name="rent_period"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('rent_period') border-red-500 @enderror">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="floor_number" value="{{ old('floor_number', $property->floor_number) }}" min="0"
                        ...
                        <div class="space-y-2">
                            @php
                                ...
                                if (!is_array($utilities) && is_string($utilities)) {
                                    $utilities = json_decode($utilities) ?? [];
                                }
                            @endphp
